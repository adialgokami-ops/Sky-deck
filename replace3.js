...
// Also 'shadow-lg shadow-black/20' is two classes, wait, if I parse by space, I won't match 'shadow-lg shadow-black/20'.
// But in the user request, it's just a sequence. I'll just do string replacement for the remaining unfixed ones first!
const unfixedStrMap = {
  'bg-[#0F0F12]/90': 'bg-white/90 dark:bg-[#0F0F12]/90',
  'bg-[#0F0F12]/95': 'bg-white/95 dark:bg-[#0F0F12]/95',
  '"text-gold-400"': '"text-gold-600 dark:text-gold-400"',
  '"text-white"': '"text-stone-900 dark:text-white"',
  ' shadow-lg shadow-black/20': ' shadow-lg shadow-stone-300/40 dark:shadow-black/20', // just in case
  'from-[#1a1510]': 'from-[#F5F0E8] dark:from-[#1a1510]',
  'via-[#0F0F12]': 'via-[#FAF9F6] dark:via-[#0F0F12]',
  'to-[#0F0F12]': 'to-[#FAF9F6] dark:to-[#0F0F12]',
  'from-[#0F0F12]': 'from-[#FAF9F6] dark:from-[#0F0F12]',
...
// Then for shadow-sm: "Add shadow-sm dark:shadow-none to card containers that use border + bg-white in light mode"
// bg-white in light mode means ones that had bg-white/[0.01] -> bg-stone-50/80, or bg-[#0F0F12] -> bg-[#FAF9F6], etc.
// Let's just manually replace any class string that has border and one of those light bg colors.
